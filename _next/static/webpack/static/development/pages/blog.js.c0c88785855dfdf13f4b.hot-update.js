...
var filter = function filter(item) {
  var author_association = item.author_association,
      html_url = item.html_url;
  return author_association === 'OWNER' && html_url.includes('github.com/Coyeah/blog/issues');
};

var Blog = function Blog(props) {
  var _getBlogTotal = Object(_apis__WEBPACK_IMPORTED_MODULE_5__["getBlogTotal"])(function (data) {
    return data.items.filter(filter).map(function (_ref) {
...
//# sourceMappingURL=blog.js.c0c88785855dfdf13f4b.hot-update.js.map